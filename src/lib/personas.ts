export interface SaintPersona {
  ...
  agentId: string // Eleven Labs Conversational AI agent ID
}
...
export const SAINT_PERSONAS: SaintPersona[] = [
  {
    ...
    agentId: 'agent_9201k7wqfr7gfara7jbg959wkpnj'
  },
  {
    key: 'teresa_avila',
    ...
    agentId: 'agent_1201k7wr8rpzfhvvqz8g4smw4nke'
  },
  {
    key: 'francis_assisi',
    ...
    agentId: 'agent_7001k7wr456wepjsvys1yvz66t2h'
  }
]
