      ...
      try {
        ...
        if (response.ok) {
          ...
          if (paymentSuccess && data.hasAccess) {
            track("Subscription Success Confetti Shown");
          ...
          <Card className="border-yellow-500/20 bg-gradient-to-br from-yellow-500/5 to-primary/5">
            <CardHeader className="text-center space-y-4">
              ...
              <CardDescription className="text-base">
                Hablar con los santos es una función exclusiva para suscriptores
                premium
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="bg-background/50 rounded-lg p-6 space-y-4">
                <h3 className="font-semibold text-lg">
                  Con la suscripción premium obtienes:
                </h3>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Habla directamente con un santo y recibe orientación espiritual
                en tiempo real
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          {!isConnected && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Elige con quién deseas conversar
                </CardDescription>
              </CardHeader>
              <CardContent>
                <SaintPicker
                ...
                {!isConnected ? (
                  <div className="space-y-3 text-sm text-muted-foreground">
                    ...
                    <ul className="space-y-2 ml-4">
                      ...
                      <li>
                        • Permite el acceso al micrófono cuando se te solicite
                      </li>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <p className="text-muted-foreground">
                      El santo te escucha y responderá en tiempo real. Habla con
                      tranquilidad y espera su respuesta.
                    </p>
                  </div>
                )}
            ...
            <CardContent>
              <div className="space-y-3 text-sm text-muted-foreground">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Haz preguntas específicas sobre tu vida espiritual o
                    situación actual
                  </p>
                </div>
                <div className="flex items-start gap-2">
