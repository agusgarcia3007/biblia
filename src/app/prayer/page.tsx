          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Selecciona tu intención y deja que la oración se adapte a tus necesidades
                  espirituales
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Intención de oración</CardTitle>
                <CardDescription>Selecciona el propósito de tu oración</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {PRAYER_INTENTS.map((intent) => (
                    <Badge
                      key={intent.key}
                      variant={selectedIntent === intent.key ? 'default' : 'outline'}
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">Contexto adicional (opcional)</CardTitle>
                <CardDescription>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary">
                    {PRAYER_INTENTS.find((i) => i.key === generatedPrayer.intentTag)?.label}
                  </Badge>
                </div>
                <CardDescription>
                  {personaKey === 'augustin'
