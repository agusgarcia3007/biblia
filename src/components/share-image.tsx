  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-12">
        <div className="text-6xl font-bold text-primary">bibliAI</div>
      ...
      <Card className="flex-1 flex flex-col justify-center p-16 bg-card/95 backdrop-blur">
        <div className="space-y-8">
          ...
          <blockquote className="border-l-8 border-primary pl-8 py-4">
            <p className="text-4xl leading-relaxed italic text-foreground break-words">
              &quot;{content.text}&quot;
            </p>
          </blockquote>
          ...
          {/* Subtitle/Reflection */}
          {content.subtitle && (
            <p className="text-3xl text-muted-foreground leading-relaxed break-words">
              {content.subtitle}
            </p>
          )}
        </div>
      ...
      <div className="mt-12 text-center">
        <div className="text-3xl text-muted-foreground">Descubre más en</div>
        <div className="text-4xl font-bold text-primary mt-2">bibliAI.org</div>
      </div>
    </div>
  );
}
